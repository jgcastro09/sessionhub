...
func (s *Server) routes(mux *http.ServeMux) {
	...
	api.HandleFunc("GET /api/v2/projects/{projectID}/registry/config", s.handleRegistryConfigGet)
	api.HandleFunc("PUT /api/v2/projects/{projectID}/registry/config", s.handleRegistryConfigPut)
	...
	api.HandleFunc("GET /api/v2/projects/{projectID}/registry/search/semantic", s.handleRegistrySemanticSearch)
	api.HandleFunc("GET /api/v2/projects/{projectID}/registry/graph", s.handleRegistryGraph)
	...
	api.HandleFunc("GET /api/v2/projects/{projectID}/registry/entries/{entryID}/source/history", s.handleRegistrySourceHistory)
	api.HandleFunc("GET /api/v2/projects/{projectID}/registry/entries/{entryID}/source/at", s.handleRegistrySourceAtRevision)
	api.HandleFunc("POST /api/v2/projects/{projectID}/registry/entries/{entryID}/review", s.handleRegistryReview)
	api.HandleFunc("GET /api/v2/projects/{projectID}/registry/entries/{entryID}/graph", s.handleRegistryEntryGraph)
